...
module.exports = function (Categories) {
    ...
    Categories.getIgnorers = function (cid, start, stop) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // The next line calls a function in a module that has not been updated to TS yet
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call
            const ignorers = yield database_1.default.getSortedSetRevRangeByScore(`cid:${cid}:uid:watch:state`, start, count, Categories.watchStates.ignoring, Categories.watchStates.ignoring);
            return ignorers;
        });
    };
